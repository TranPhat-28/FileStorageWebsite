                        ...
                        <div class="panel panel-primary">
                            ...
                            <div class="panel-body">
                                <div style="width:100%; margin:5px;" align="center">
                                    <form action="HandlingUP.php" method="post" enctype="multipart/form-data" name="upload">
					 <div class="form-group">
                                        	<label>File Name : </label>
                                        	<input type="text" name="fname" class="form-control" placeholder="File Name" onkeyup='countChar(this)' autocomplete="false" required/><br />
                                    	 </div>
                                        <div class="form-group">
